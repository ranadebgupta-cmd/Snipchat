...
import { MessageCircle } from 'lucide-react'; // Import an icon for visual appeal

const Login = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-400 to-purple-600 dark:from-gray-900 dark:to-indigo-950 p-4 animate-gradient-xy">
      <style>{`
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-3xl">
        ...
        <Auth
            ...
            variables: {
              default: {
                colors: {
                  ...
                  // Customize other colors to match your theme
          ...
          theme="light" // You might want to make this dynamic based on user preference

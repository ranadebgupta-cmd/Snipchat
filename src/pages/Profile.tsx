...
const Profile = () => {
  ...
  const gradientBackgroundClasses = "min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 to-purple-600 dark:from-gray-900 dark:to-indigo-950 p-4 animate-gradient-xy";
    ...
    <div className={gradientBackgroundClasses}>
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-3xl animate-fade-in">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div>
            <Label htmlFor="firstName" className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2 block">
              First Name
            </Label>
            <Input
              id="firstName"
          ...
          <div>
            <Label htmlFor="lastName" className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2 block">
              Last Name
            </Label>
            <Input
              id="lastName"
